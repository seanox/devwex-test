 ...
 * <br>
 * WorkerTest_Get 5.2.0 20200410<br>
...
public class WorkerTest_Get extends AbstractTest {
    ...
    /** 
     * Test case for acceptance.
     * Directories without a slah at the end, are responded with status 302 and
     * a redirect.
     * @throws Exception
     */    
    @Test
    ...
    /** 
     * Test case for acceptance.
     * Requests with a incorrect If-Modified-Since are responded with status 200.
     * @throws Exception
     */  
    @Test
    ...
    private void assertAcceptance_26(int count, String path, String start, String end) throws Exception {
    ...
    public void testAcceptance_27() throws Exception {
        ...
        for (String path : new String[] {"/partial_content.txt", "/partial_content_empty.txt",
            ...
            String requestLastModified = "HEAD " + path + " HTTP/1.0\r\n"
                    + "Host: vHa\r\n"
                    + "\r\n";
            String responseLastModified = this.sendRequest("127.0.0.1:18180", requestLastModified);       
            ...
            if (path.equals("/")) {
                requestLastModified = "Get /documents/commons/lastmodified.jsx HTTP/1.0\r\n"
                        ...
                        + "Host: vHa\r\n"
                        + "\r\n";
                responseLastModified = this.sendRequest("127.0.0.1:18180", requestLastModified);
